      ...
      <CardContent className="p-6 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-center gap-3 mt-1">
          ...
          <Button
            ...
            className="flex-1 h-11 rounded-xl border-border/80 bg-background hover:bg-accent flex items-center justify-center transition-all"
          >
            <svg className="size-5 fill-foreground transition-colors" viewBox="0 0 170 170" aria-label="Apple">
              <path d="M150.37 130.25c-2.45 5.66-5.35 10.87-8.71 15.66-4.58 6.53-8.33 11.05-11.22 13.56-4.48 4.12-9.28 6.23-14.42 6.35-3.69 0-8.14-1.05-13.32-3.18-5.19-2.12-9.97-3.17-14.34-3.17-4.58 0-9.49 1.05-14.75 3.17-5.26 2.13-9.5 3.24-12.74 3.35-4.84.13-9.64-1.9-14.42-6.1-3.23-2.76-7.14-7.44-11.75-14.04-6.04-8.62-10.83-18.06-14.38-28.32-3.55-10.26-5.32-20.19-5.32-29.79 0-11.83 2.92-21.75 8.76-29.76 5.84-8.01 13.31-12.14 22.42-12.39 4.38 0 9.28 1.15 14.7 3.44 5.43 2.29 9.22 3.44 11.38 3.44 1.86 0 5.72-1.2 11.58-3.59 5.86-2.39 10.6-3.48 14.23-3.27 9.87.65 17.65 4.7 23.36 12.15-8.79 5.34-13.06 12.7-12.8 22.08.26 9.4 4.8 17.06 13.62 22.97-1.92 5.68-4.52 11.33-7.8 16.95zM119.22 31.62c0-5.83 2.14-11.45 6.42-16.85 4.28-5.41 9.69-9.15 16.23-11.22.53 5.92-1.39 11.64-5.76 17.16-4.37 5.52-9.84 9.17-16.41 10.95-.16-.01-.32-.02-.48-.04z" />
            </svg>
          </Button>
          ...
          <Button
            ...
            className="flex-1 h-11 rounded-xl border-border/80 bg-background hover:bg-accent flex items-center justify-center transition-all"
          >
            <svg className="size-5 fill-foreground transition-colors" viewBox="0 0 24 24" aria-label="GitHub">

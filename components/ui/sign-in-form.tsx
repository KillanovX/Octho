      ...
      <CardContent className="p-6 flex flex-col gap-6">
        ...
        <div className="flex items-center justify-center gap-3 mt-1">
          ...
          <Button
            ...
            className="flex-1 h-11 rounded-xl border-border/80 bg-background hover:bg-accent flex items-center justify-center transition-all"
          >
            <svg className="size-5 shrink-0 fill-foreground transition-colors" viewBox="0 0 24 24" aria-label="Apple">
          ...
          <Button
            ...
            className="flex-1 h-11 rounded-xl border-border/80 bg-background hover:bg-accent flex items-center justify-center transition-all"
          >
            <svg className="size-5 shrink-0 fill-foreground transition-colors" viewBox="0 0 24 24" aria-label="GitHub">
